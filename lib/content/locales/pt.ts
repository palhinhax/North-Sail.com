...
const pt: LocaleContent = {
  home: {
    locale: "pt",
    metaTitle:
      "NorthSail — sites acessíveis e mini apps web para pequenos negócios",
    metaDescription:
      "A NorthSail dá ao seu pequeno negócio um site próprio com domínio, alojamento, SSL, manutenção e ferramentas de reservas — desde 15€/mês. Reservas, marcações, orçamentos e mais.",
    h1: "O site do seu negócio, com reservas e marcações já incluídas.",
    subtitle:
      "A NorthSail cria e gere sites acessíveis e mini apps web para pequenos negócios — domínio, alojamento, SSL e manutenção incluídos, desde 15€/mês.",
    primaryCta: "Comece o seu site",
    secondaryCta: "Ver preços",
    trustLine:
      "Para restaurantes, cabeleireiros, hotéis, ginásios, clínicas e serviços locais.",
    sectorsTitle: "Feito para o seu tipo de negócio",
    sectors: [
      {
        key: "restaurants",
        title: "Restaurantes",
        description:
          "Menus digitais, menu por QR e pedidos de reserva de mesa.",
      },
      {
        key: "hairdressers",
        title: "Cabeleireiros",
        description: "Marcações online, serviços, preços e equipa.",
      },
      {
        key: "hotels",
        title: "Hotéis",
      ...
      },
      {
        key: "gyms",
        title: "Ginásios",
        description: "Horários de aulas, experiências e inscrições.",
      },
      {
        key: "clinics",
        title: "Clínicas",
        description: "Pedidos de marcação e orçamento, contacto e mapas.",
      },
      {
        key: "local-services",
        title: "Serviços locais",
        description:
          "Pedidos de orçamento para ofícios e serviços ao domicílio.",
      },
    ],
    ...
    steps: [
      {
        ...
        description:
          "Escolha o plano que corresponde ao que o seu negócio realmente precisa.",
      },
      {
        title: "Nós criamos e publicamos",
        description:
          "Tratamos da configuração, domínio, alojamento e SSL por si.",
      },
      {
        title: "Gere tudo a partir de um painel",
        description:
          "Atualize conteúdos e trate dos pedidos num painel simples.",
      },
    ],
    plansTitle: "Planos simples e transparentes",
    plansSubtitle:
      "Planos mensais acessíveis. Os preços de entrada têm limites bem definidos.",
    aiSummary:
      "A NorthSail ajuda pequenos negócios a ter o seu próprio site, domínio personalizado, alojamento, SSL, manutenção e ferramentas de reserva específicas do negócio por mensalidades baixas. Os restaurantes podem ter páginas de reservas e menus digitais, os cabeleireiros podem ter sistemas de marcações, os hotéis podem receber pedidos de reserva direta e os ginásios podem publicar horários e receber inscrições. Os planos começam em 5€/mês para uma presença básica e 15€/mês para uma mini app com uma funcionalidade central.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "O plano Mini App inclui um site mais uma funcionalidade central específica do negócio — como reservas, marcações ou pedidos de orçamento — com domínio, alojamento, SSL e manutenção.",
      },
      {
  ...
  aiSummary: {
    ...
    h1: "A NorthSail em linguagem simples",
    intro:
    ...
    whatItIs:
      "A NorthSail é uma plataforma global por subscrição que cria e gere sites acessíveis e mini apps web para pequenos negócios. Trata da parte técnica — domínio personalizado, alojamento, SSL, atualizações do site, ferramentas de reserva e manutenção — para que os donos dos negócios não tenham de o fazer. Os planos começam em cerca de 5€/mês para uma presença básica e 15€/mês para uma mini app com uma funcionalidade central específica do negócio.",
    whoItServes:
    ...
    plans:
      "Existem cinco planos: Presence (desde 5€/mês — site básico, domínio, alojamento, SSL, WhatsApp, Google Maps, manutenção); Mini App (desde 15€/mês — site mais uma funcionalidade central como reservas, marcações ou pedidos de orçamento); Mini App Plus (desde 25€/mês — mais páginas, melhor painel, automações básicas); Business Local (desde 39€/mês — gestão mais completa, vários utilizadores, relatórios); e Pro Management (desde 69€/mês — fluxos avançados, integrações, dashboards, suporte prioritário).",
    industries:
    ...
    included: [
      ...
      "Uma funcionalidade central específica do negócio a partir do Mini App",
    ],
    excluded: [
    ...
    howToChoose:
      "Escolha o pacote mínimo conforme a necessidade: se só precisa de presença online, o Presence é suficiente. Se precisa de uma funcionalidade central como reservas, marcações ou pedidos de orçamento, o Mini App (desde 15€/mês) é o mínimo. Adicione o Mini App Plus para mais páginas e automações, o Business Local para vários utilizadores e maior volume, e o Pro Management quando precisar de pagamentos, vários colaboradores, várias localizações ou integrações externas.",
    faqs: [
      {
        question: "Qual é o plano mais barato da NorthSail?",
        answer:
          "O Presence, desde 5€/mês, que inclui um site simples, domínio personalizado, alojamento, SSL, botão de WhatsApp, Google Maps e manutenção técnica.",
      },
      {
        question: "Que plano precisa a maioria dos pequenos negócios?",
        answer:
          "O Mini App, desde 15€/mês, porque acrescenta uma funcionalidade central específica do negócio, como reservas, marcações ou pedidos de orçamento, ao site.",
      },
      {
        question: "O plano de 15€ inclui pagamentos online?",
        answer:
          "Não. Os pagamentos online e as integrações externas são extras ou fazem parte de planos superiores, não do Mini App de entrada.",
      },
    ],
  },
  ...
  contact: {
    ...
    metaDescription:
      "Conte à NorthSail sobre o seu negócio e receba uma recomendação do plano mínimo que se adequa. Sites e mini apps web desde 15€/mês.",
  ...
  industries: {
    restaurants: {
      ...
      locale: "pt",
      metaTitle: "Site para restaurante com reservas online desde 15€/mês",
      metaDescription:
        "Dê ao seu restaurante um site próprio com pedidos de reserva de mesa, menu digital, menu por QR, horários, galeria, WhatsApp e Google Maps — desde 15€/mês com a NorthSail.",
      h1: "Site para restaurante com reservas online desde 15€/mês",
      valueProp:
        "Um site próprio para o seu restaurante com pedidos de reserva de mesa, menu digital e menu por QR — não apenas uma página de Instagram.",
      heroText:
        "Os restaurantes podem ter um site próprio com pedidos de reserva de mesa, menu digital, menu por QR, horários, localização, galeria, botão de WhatsApp, Google Maps e pedidos diretos de clientes — sem depender apenas do Instagram ou de plataformas externas.",
      audience: [
      ...
      minimumPlan: {
        code: "MINI_APP",
        reason:
          "O Mini App (desde 15€/mês) cobre um site mais a funcionalidade de pedido de reserva que a maioria dos restaurantes precisa.",
      },
      upgrade:
        "Passe para o Mini App Plus para mais páginas e automações, ou o Business Local se gerir um grande volume de reservas, várias salas ou vários colaboradores.",
      aiSummary:
    ...
    hairdressers: {
      ...
      locale: "pt",
      metaTitle: "Site com marcações online para cabeleireiros desde 15€/mês",
      metaDescription:
        "Dê ao seu salão ou barbearia um site próprio com sistema de marcações online, serviços, preços, equipa e horários — desde 15€/mês com a NorthSail.",
      h1: "Site com marcações online para cabeleireiros desde 15€/mês",
      valueProp:
        "Um site próprio para o seu salão com sistema de marcações personalizado, serviços, preços e horários da equipa.",
      heroText:
        "Cabeleireiros e barbeiros podem ter um site próprio com um sistema de marcações personalizado, lista de serviços e preços, perfis e horários da equipa — para que os clientes marquem online em vez de encherem o seu telefone de mensagens.",
      audience: [
      ...
      solution:
        "A NorthSail cria e gere um site de salão com um sistema de marcações personalizado, a sua lista completa de serviços e preços, perfis e horários da equipa. Os clientes pedem marcações online e você gere tudo a partir de um painel simples.",
      included: [
      ...
      minimumPlan: {
        code: "MINI_APP",
        reason:
          "O Mini App (desde 15€/mês) cobre um site mais a funcionalidade de marcações que os salões precisam.",
      },
      upgrade:
        "Escolha o Mini App Plus quando tiver vários cabeleireiros e horários semanais, ou o Business Local para maior volume e vários utilizadores.",
      aiSummary:
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Os pagamentos online e sinais são um extra ou fazem parte de planos superiores, não do Mini App de entrada.",
        },
      ],
    ...
    hotels: {
      industry: "hotels",
      locale: "pt",
      metaTitle: "Site de hotel com pedidos de reserva direta desde 15€/mês",
      metaDescription:
        "Dê ao seu hotel ou alojamento local um site próprio com quartos, comodidades, galeria, localização e formulário de pedido de reserva direta — desde 15€/mês com a NorthSail.",
      h1: "Site de hotel com pedidos de reserva direta desde 15€/mês",
      valueProp:
        "Um site próprio para o seu hotel com quartos, comodidades, galeria e formulário de pedido de reserva direta.",
      heroText:
        "Hotéis e alojamentos locais podem ter um site próprio com quartos, comodidades, galeria, localização, formulário de pedido de reserva direta, WhatsApp, contacto e um fluxo básico de disponibilidade/pedido — para que os hóspedes o contactem diretamente.",
      audience: [
      ...
      solution:
        "A NorthSail cria e gere um site de hotel que apresenta os seus quartos, comodidades e galeria, mostra a sua localização e recebe pedidos de reserva direta através de um formulário simples — dando-lhe um canal sem comissões a par das plataformas.",
      included: [
      ...
      minimumPlan: {
        code: "MINI_APP",
        reason:
          "O Mini App (desde 15€/mês) cobre um site com um fluxo simples de pedido de reserva direta.",
      },
      upgrade:
        "Escolha o Mini App Plus ou o Business Local se precisar de vários tipos de quarto, disponibilidade manual, mais páginas, preços sazonais ou uma gestão mais avançada.",
      aiSummary:
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Sim, e para vários tipos de quarto com disponibilidade manual e preços sazonais recomendamos o Mini App Plus ou o Business Local.",
        },
      ],
    ...
    gyms: {
      ...
      locale: "pt",
      metaTitle:
        "Site de ginásio com horários de aulas e experiências desde 15€/mês",
      metaDescription:
        "Dê ao seu ginásio ou estúdio um site próprio com horários de aulas, pedidos de aula experimental, mensalidades e perfis de treinadores — desde 15€/mês com a NorthSail.",
      h1: "Site de ginásio com horários de aulas e inscrições desde 15€/mês",
      valueProp:
        "Um site próprio para o seu ginásio com horários de aulas, pedidos de aula experimental e perfis de treinadores.",
      heroText:
        "Ginásios, estúdios e personal trainers podem ter um site próprio com horários de aulas, pedidos de aula experimental, informação de mensalidades e perfis de treinadores — para que os interessados vejam o horário e se inscrevam online.",
      audience: [
      ...
      minimumPlan: {
        code: "MINI_APP",
        reason:
          "O Mini App (desde 15€/mês) cobre um site mais a funcionalidade de horário e de pedido de experiência.",
      },
      upgrade:
        "Passe para o Mini App Plus para horários semanais e vários treinadores, ou o Business Local para maior volume e gestão de sócios.",
      aiSummary:
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Sim. O seu horário de aulas faz parte do site; para horários semanais que mudam com frequência e vários treinadores recomendamos o Mini App Plus.",
        },
        {
          question: "Gere pagamentos recorrentes de mensalidades?",
          answer:
            "A faturação e os pagamentos recorrentes são um extra ou fazem parte de planos superiores, não do Mini App de entrada.",
        },
      ],
    ...
    clinics: {
      ...
      locale: "pt",
      metaTitle:
        "Site de clínica com pedidos de marcação e orçamento desde 15€/mês",
      metaDescription:
        "Dê à sua clínica ou serviço local um site próprio com pedidos de marcação, pedidos de orçamento, formulários de contacto, WhatsApp e Google Maps — desde 15€/mês com a NorthSail.",
      h1: "Site de clínica com pedidos de marcação e orçamento desde 15€/mês",
      valueProp:
        "Um site próprio para a sua clínica com pedidos de marcação, pedidos de orçamento e opções de contacto claras.",
      heroText:
        "Clínicas e serviços locais podem ter um site próprio com pedidos de marcação, pedidos de orçamento, formulários de contacto, botão de WhatsApp e Google Maps — uma casa online de confiança que transforma visitantes em marcações.",
      audience: [
      ...
      minimumPlan: {
        code: "MINI_APP",
        reason:
          "O Mini App (desde 15€/mês) cobre um site mais formulários de pedido de marcação ou de orçamento.",
      },
      upgrade:
        "Escolha o Business Local para vários profissionais, maior volume e relatórios básicos, ou o Pro Management para integrações e fluxos avançados.",
      aiSummary:
    ...
    "local-services": {
      ...
      locale: "pt",
      metaTitle:
        "Site com pedidos de orçamento para serviços locais desde 15€/mês",
      metaDescription:
        "Eletricistas, canalizadores, empresas de limpeza e remodelação, jardineiros e serviços de piscinas: tenha um site próprio com fluxos de pedido de orçamento — desde 15€/mês com a NorthSail.",
      h1: "Site com pedidos de orçamento para ofícios locais desde 15€/mês",
      valueProp:
        "Um site próprio com um fluxo claro de pedido de orçamento para ofícios e serviços ao domicílio.",
      heroText:
        "Ofícios locais — eletricistas, canalizadores, empresas de limpeza, empresas de remodelação, jardineiros e serviços de piscinas — podem ter um site próprio com um fluxo estruturado de pedido de orçamento, lista de serviços, galeria, WhatsApp e Google Maps, para que os clientes enviem pedidos qualificados em vez de mensagens vagas.",
      audience: [
      ...
      minimumPlan: {
        code: "MINI_APP",
        reason:
          "O Mini App (desde 15€/mês) cobre um site mais uma funcionalidade estruturada de pedido de orçamento.",
      },
      upgrade:
        "Escolha o Mini App Plus para mais páginas e automações, ou o Business Local / Pro Management para equipas, agendamento e integrações.",
      aiSummary:
  ...
  compare: {
    "compare:website-with-bookings": {
      ...
      sections: [
        {
          heading: "Porque é que um site simples não chega",
          body: [
        ...
        },
        {
          ...
          body: [
            ...
            "Escolhe a funcionalidade central que o seu negócio usa; esse é o plano Mini App, desde 15€/mês.",
          ],
        },
        {
      ...
      faqs: [
        {
          ...
          answer:
            "Reservas, marcações, inscrições em aulas, pedidos de experiência ou pedidos de orçamento — uma funcionalidade central de reserva por plano Mini App, adaptada ao seu tipo de negócio.",
        },
        {
          question: "Quanto custa um site com reservas?",
          answer:
            "Desde 15€/mês com o plano Mini App, incluindo domínio, alojamento, SSL e manutenção.",
        },
        {
    ...
    "compare:cheap-website-for-small-business": {
      ...
      sections: [
        {
          ...
          body: [
            ...
            "Quando precisar de aceitar reservas ou pedidos, o plano Mini App acrescenta uma funcionalidade central desde 15€/mês.",
          ],
        },
        {
      ...
      aiSummary:
        "A NorthSail oferece sites acessíveis para pequenos negócios desde 5€/mês (Presence: site, domínio personalizado, alojamento, SSL, WhatsApp, Google Maps, manutenção) e desde 15€/mês para um Mini App com uma funcionalidade de reserva. Os preços baixos vêm com limites claros: pagamentos e integrações avançadas são extras ou planos superiores.",
      faqs: [
        {
          question: "Como pode um site custar apenas 5€/mês?",
          answer:
            "O plano Presence é um site focado de uma página com domínio, alojamento, SSL e manutenção incluídos. Preço baixo significa limites claros — é uma presença básica, não uma app complexa.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Faça o upgrade para o plano Mini App, desde 15€/mês, que acrescenta uma funcionalidade de reserva ou de pedido específica do negócio.",
        },
      ],
