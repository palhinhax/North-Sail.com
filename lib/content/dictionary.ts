...
const en: Dictionary = {
  ...
  footerTagline: "Your business, upgraded with simple digital tools.",
...
const pt: Dictionary = {
  ...
  navLogin: "Entrar",
  navDashboard: "Painel",
  footerTagline: "O seu negócio, atualizado com ferramentas digitais simples.",
...
const es: Dictionary = {
  ...
  navLogin: "Entrar",
  navDashboard: "Panel",
  footerTagline: "Tu negocio, mejorado con herramientas digitales simples.",
...
const fr: Dictionary = {
  ...
  footerTagline:
    "Votre entreprise, modernisée avec des outils numériques simples.",
...
const de: Dictionary = {
  ...
  navLogin: "Anmelden",
  navDashboard: "Dashboard",
  footerTagline: "Ihr Unternehmen, aufgewertet mit einfachen digitalen Tools.",
